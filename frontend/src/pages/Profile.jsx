...
//   // LEVEL 1 — settings menu
//   const [showSettings, setShowSettings] = useState(false);

//   // LEVEL 2 — submenu
//   const [submenu, setSubmenu] = useState(null); // "account", "privacy"

//   // LEVEL 3 — forms
//   const [formType, setFormType] = useState(null); // "name", "username", "email", "password"
...
//           <div className="bg-white/10 p-6 rounded-xl w-full max-w-sm border border-white/20">
...
//       {/* LEVEL 3 — PASSWORD FORM */}
//       {formType === "password" && (
//         <PasswordModal onClose={closeAll} />
//       )}
...
// /* Reusable modal for name/email/username */
// function FormModal({ title, placeholder, onClose }) {
//   return (
//     <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50">
//       <div className="bg-white/10 p-6 rounded-xl w-full max-w-md border border-white/20 shadow-xl">
...
//         <button className="w-full bg-primary py-2 rounded-lg mb-2 text-white btn">
//           Save
//         </button>

//         <button onClick={onClose} className="w-full bg-white/10 py-2 rounded-lg text-indigo-200">
//           Close
//         </button>
//       </div>
//     </div>
